...
<div class="admin_contents_area">
    ...
    <div class="container contents_area">
        <div class="column">
            <h1 class="is-size-3 has-text-weight-semibold">투표 - 수정하기</h1>
            <form action="${path }/vote/update.do" method="post" class="mt-5">
                <table class="table is-fullwidth is-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" name="addPt" id="addPt" class="input" value="${vote.addPt}" required>
                        </td>
                    </tr>
                    </tbody>
                </table>
